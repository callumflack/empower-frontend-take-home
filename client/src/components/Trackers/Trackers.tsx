...
// I would break this file apart into smaller components
// as well as separate the state management
// most of the business logic may live on the backend
// but for the sake of time I left it here to demonstrate
      ...
      <Modal title="Add New Tracker" isOpen={modalOpen} setOpen={closeModal}>
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <input
            name="id"
            className="hidden"
            defaultValue={selectedTracker?.id ?? trackers?.length! + 1}
          />
          <Input
            name="budget"
